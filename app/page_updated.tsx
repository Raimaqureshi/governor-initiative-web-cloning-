  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-center mt-4">
        <Image src="/pictures/228.png" alt="Image 1" width={300} height={300} className="w-full p-2" />
        <Image src="/pictures/231.png" alt="Image 2" width={300} height={300} className="w-full p-2" />
        <Image src="/pictures/232.png" alt="Image 3" width={300} height={300} className="w-full p-2" />
      </div>
